...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title">Wayfair Product Management - ADD NEW PRODUCT</h3>
        <div class="row">
                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="product-name"><input name="name" style="width: 60%" type="text" value="Null"/></td>
                                <td class="product-name"><input name="manufacturer" style="width: 90%" type="text" value="Null"/></td>
